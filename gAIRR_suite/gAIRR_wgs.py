...
def main():
    parser = argparse.ArgumentParser(description="gAIRR-wgs pipeline of gAIRR-suite.")
    ...
    parser.add_argument('-REF', '--reference', help="Path to material directory [default: material/]", default=os.path.dirname(__file__) + '/material/')
    ...
    path_material = args.reference
    if not path_material.endswith('/'):
        path_material += '/'
    ...
    for allele_name in list_allele_names:
        ...
        print("[gAIRRCall: gAIRR-wgs]", person_name, allele_name, "novel allele calling...")
        ...
        print("[gAIRRCall: gAIRR-wgs]", person_name, allele_name, "allele calling...")
        ...
        if flag_flanking:
            print("[gAIRRCall: gAIRR-wgs]", person_name, allele_name, "flanking sequence calling...")
